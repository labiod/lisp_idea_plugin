...
public class LispLetVarBlockImpl extends ASTWrapperPsiElement implements LispLetVarBlock {

  public LispLetVarBlockImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LispVisitor visitor) {
    visitor.visitLetVarBlock(this);
  }
