...
public class LispOperationFormImpl extends ASTWrapperPsiElement implements LispOperationForm {

  public LispOperationFormImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LispVisitor visitor) {
    visitor.visitOperationForm(this);
  }
  ...
  @Override
  @NotNull
  public LispOperation getOperation() {
    return findNotNullChildByClass(LispOperation.class);
  }
