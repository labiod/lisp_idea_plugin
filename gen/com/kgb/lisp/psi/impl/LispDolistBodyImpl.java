...
public class LispDolistBodyImpl extends ASTWrapperPsiElement implements LispDolistBody {

  public LispDolistBodyImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LispVisitor visitor) {
    visitor.visitDolistBody(this);
  }
