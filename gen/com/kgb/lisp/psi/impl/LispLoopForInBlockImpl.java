...
public class LispLoopForInBlockImpl extends ASTWrapperPsiElement implements LispLoopForInBlock {

  public LispLoopForInBlockImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LispVisitor visitor) {
    visitor.visitLoopForInBlock(this);
  }
