...
public class LispSlotOptionImpl extends ASTWrapperPsiElement implements LispSlotOption {

  public LispSlotOptionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LispVisitor visitor) {
    visitor.visitSlotOption(this);
  }
