...
public class LispListArgImpl extends ASTWrapperPsiElement implements LispListArg {

  public LispListArgImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LispVisitor visitor) {
    visitor.visitListArg(this);
  }
  ...
  public LispStringArg getStringArg() {
    return findChildByClass(LispStringArg.class);
  }
