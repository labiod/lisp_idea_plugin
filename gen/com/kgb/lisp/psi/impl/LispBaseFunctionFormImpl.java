...
public class LispBaseFunctionFormImpl extends ASTWrapperPsiElement implements LispBaseFunctionForm {

  public LispBaseFunctionFormImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LispVisitor visitor) {
    visitor.visitBaseFunctionForm(this);
  }
  ...
  @Override
  @NotNull
  public LispBaseFunction getBaseFunction() {
    return findNotNullChildByClass(LispBaseFunction.class);
  }
