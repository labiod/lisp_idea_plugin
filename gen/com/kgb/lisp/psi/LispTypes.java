...
public interface LispTypes {
  ...
  IElementType ELSE_BLOCK = new LispElementType("ELSE_BLOCK");
  ...
  IElementType IF_BLOCK = new LispElementType("IF_BLOCK");
  IElementType IF_BODY = new LispElementType("IF_BODY");
    ...
    public static PsiElement createElement(ASTNode node) {
      IElementType type = node.getElementType();
       if (type == ARG) {
        ...
        return new LispElseBlockImpl(node);
      }
        ...
        return new LispIfBlockImpl(node);
      }
      else if (type == IF_BODY) {
        return new LispIfBodyImpl(node);
      }
