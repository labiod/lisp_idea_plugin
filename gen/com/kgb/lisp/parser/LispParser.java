...
public class LispParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // LP SPACE* dolist SPACE* dolist_arg SPACE* block_body SPACE* RP
  ...
  /* ********************************************************** */
  // (LP SPACE* block_body* SPACE* RP) | block_body | arg
  ...
  private static boolean else_block_0(PsiBuilder b, int l) {
    ...
    Marker m = enter_section_(b);
    r = consumeToken(b, LP);
    r = r && else_block_0_1(b, l + 1);
    r = r && else_block_0_2(b, l + 1);
    r = r && else_block_0_3(b, l + 1);
    r = r && consumeToken(b, RP);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // SPACE*
  private static boolean else_block_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "else_block_0_1")) return false;
    int c = current_position_(b);
    while (true) {
      if (!consumeToken(b, SPACE)) break;
      if (!empty_element_parsed_guard_(b, "else_block_0_1", c)) break;
      c = current_position_(b);
    }
    return true;
  }
  ...
  // block_body*
  private static boolean else_block_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "else_block_0_2")) return false;
    int c = current_position_(b);
    while (true) {
      if (!block_body(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "else_block_0_2", c)) break;
      c = current_position_(b);
    }
    return true;
  }
  ...
  // SPACE*
  private static boolean else_block_0_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "else_block_0_3")) return false;
    int c = current_position_(b);
    while (true) {
      if (!consumeToken(b, SPACE)) break;
      if (!empty_element_parsed_guard_(b, "else_block_0_3", c)) break;
      c = current_position_(b);
    }
    return true;
  }
  ...
  private static boolean if_block_0(PsiBuilder b, int l) {
    ...
    Marker m = enter_section_(b);
    r = consumeToken(b, LP);
    r = r && if_block_0_1(b, l + 1);
    r = r && if_block_0_2(b, l + 1);
    r = r && if_block_0_3(b, l + 1);
    r = r && consumeToken(b, RP);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // SPACE*
  private static boolean if_block_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "if_block_0_1")) return false;
    int c = current_position_(b);
    while (true) {
      if (!consumeToken(b, SPACE)) break;
      if (!empty_element_parsed_guard_(b, "if_block_0_1", c)) break;
      c = current_position_(b);
    }
    return true;
  }
  ...
  // block_body*
  private static boolean if_block_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "if_block_0_2")) return false;
    int c = current_position_(b);
    while (true) {
      if (!block_body(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "if_block_0_2", c)) break;
      c = current_position_(b);
    }
    return true;
  }
  ...
  // SPACE*
  private static boolean if_block_0_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "if_block_0_3")) return false;
    int c = current_position_(b);
    while (true) {
      if (!consumeToken(b, SPACE)) break;
      if (!empty_element_parsed_guard_(b, "if_block_0_3", c)) break;
      c = current_position_(b);
    }
    return true;
  }
  ...
  /* ********************************************************** */
  // (if_block? SPACE* else_block) | (if_block SPACE* else_block?) | (if_block SPACE* else_block)
  public static boolean if_body(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "if_body")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, IF_BODY, "<if body>");
    r = if_body_0(b, l + 1);
    if (!r) r = if_body_1(b, l + 1);
    if (!r) r = if_body_2(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }

  // if_block? SPACE* else_block
  ...
  // if_block?
  private static boolean if_body_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "if_body_0_0")) return false;
    if_block(b, l + 1);
    return true;
  }
  ...
  private static boolean if_body_0_1(PsiBuilder b, int l) {
    ...
    while (true) {
      if (!consumeToken(b, SPACE)) break;
      if (!empty_element_parsed_guard_(b, "if_body_0_1", c)) break;
      c = current_position_(b);
    }
    return true;
  }
  ...
  // if_block SPACE* else_block?
  private static boolean if_body_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "if_body_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = if_block(b, l + 1);
    r = r && if_body_1_1(b, l + 1);
    r = r && if_body_1_2(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // SPACE*
  private static boolean if_body_1_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "if_body_1_1")) return false;
    int c = current_position_(b);
    while (true) {
      if (!consumeToken(b, SPACE)) break;
      if (!empty_element_parsed_guard_(b, "if_body_1_1", c)) break;
      c = current_position_(b);
    }
    return true;
  }
  ...
  // else_block?
  private static boolean if_body_1_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "if_body_1_2")) return false;
    else_block(b, l + 1);
    return true;
  }

  // if_block SPACE* else_block
  private static boolean if_body_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "if_body_2")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = if_block(b, l + 1);
    r = r && if_body_2_1(b, l + 1);
    r = r && else_block(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // SPACE*
  private static boolean if_body_2_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "if_body_2_1")) return false;
    int c = current_position_(b);
    while (true) {
      if (!consumeToken(b, SPACE)) break;
      if (!empty_element_parsed_guard_(b, "if_body_2_1", c)) break;
      c = current_position_(b);
    }
    return true;
  }
  ...
  /* ********************************************************** */
  // LP SPACE* IF SPACE* conditions* SPACE* if_body SPACE* RP
  ...
  /* ********************************************************** */
  // QV LP SPACE* string_arg* SPACE* RP
